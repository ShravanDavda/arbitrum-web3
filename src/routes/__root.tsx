...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn Web3, Ethereum, and Arbitrum through interactive explainers, live crypto prices, and a hands-on blockchain mining simulator." },
      { name: "author", content: "Arbitrum Builder Pods" },
      { property: "og:title", content: "ArbChain — Understanding Web3 with Arbitrum" },
      { property: "og:description", content: "Interactive Web3 learning: concepts, live prices, and a proof-of-work mining simulator." },
